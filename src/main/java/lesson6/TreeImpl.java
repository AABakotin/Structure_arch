...
/*        Node<E> child = null;
    ...
    public void traverse(TraversMode mode) {
        switch (mode) {
//            case TraversMode.PRE_ORDER -> preOrder(root); //прямой обход
//            case TraversMode.IN_ORDER -> inOrder(root); //центрированный
//            case TraversMode.POST_ORDER -> postOrder(root); //обратный порядок
